		...
		<div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5><?php echo __('Sub Categories'); ?> List</h5>
                    <div class="ibox-tools">
                    	<?php echo $this->Html->link(__('<span class="fa fa-plus"></span>&nbsp;&nbsp;New Sub Category'), array('action' => 'add'), array('escape' => false)); ?>                        <a class="collapse-link">
                ...
                <div class="ibox-content">
						...
						<table class="table table-striped table-bordered table-hover dataTables-example">
							<thead>
								<tr>
																		...
																		<th><?php echo $this->Paginator->sort('sub_link_num'); ?></th>
					...
					<tr>
						...
						<td><?php echo h($subCategory['SubCategory']['sub_category_name']); ?>&nbsp;</td>
						<td><?php echo h($subCategory['SubCategory']['level']); ?>&nbsp;</td>
						<td><?php echo h($subCategory['SubCategory']['sub_link_num']); ?>&nbsp;</td>
								<td>
			<?php echo $this->Html->link($subCategory['Category']['id'], array('controller' => 'categories', 'action' => 'view', $subCategory['Category']['id'])); ?>
						...
						<td><?php echo h($subCategory['SubCategory']['created_at']); ?>&nbsp;</td>
						<td><?php echo h($subCategory['SubCategory']['updated_at']); ?>&nbsp;</td>
						<td class="actions">
